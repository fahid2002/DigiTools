export default function Footer() {
  return (
    <footer className="bg-[#0b0d17] text-white py-16 px-6">
      {/* Changed to 6 columns: 2 for Brand, 1 each for the other 4 columns */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-6 gap-4 border-b border-white/10 pb-12">
        ...
        <div className="md:-ml-10">
            <h4 className="font-bold mb-4 tracking-widest text-sm">Product</h4>
        ...
        {/* Company Column */}
        <div className="md:-ml-10">
            <h4 className="font-bold mb-4 tracking-widest text-sm">Company</h4>
            <ul className="space-y-2 text-gray-400">
                <li>About</li>
                <li>Blog</li>
                <li>Careers</li>
        ...
        {/* Resources Column */}
        <div className="md:-ml-10">
            <h4 className="font-bold mb-4 tracking-widest text-sm">Resources</h4>
            <ul className="space-y-2 text-gray-400">
                <li>Documentation</li>
                <li>Help Center</li>
                <li>Community</li>
        ...
        {/* Social Links Column - Now sits as the 6th column beside Resources */}
        <div className="md:-ml-10">
          <h4 className="font-bold mb-4 tracking-widest text-xs text-slate-400">
            Social Links
          </h4>
      ...
      <div className="max-w-7xl mx-auto mt-8 flex flex-row justify-between text-gray-500 text-sm">
